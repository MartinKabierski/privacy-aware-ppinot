...
//TODO update to new format (see PAPPI_PRIPEL_EvaluationOptimized)
//TODO merge with PAPPI_PRIPEL_EvaluationOptimized
@Deprecated
public class PAPPI_PRIPEL_EvaluationManual {
		
	//create PPI's based on privatized PRIPEL logs (using epsilon=0.1 and p=20)
	public static void main(String[] args) throws Exception {
		PAPPI_PRIPEL_EvaluationManual app = new PAPPI_PRIPEL_EvaluationManual();
		List<Measure> pripelMeasures = null;
		List<Measure> pappiMeasures = null;
		List<Measure> trueMeasures = null;
		
		int repetitions = 10;
	    BufferedWriter writer = new BufferedWriter(new FileWriter("evaluation_sepsis_PRIPEL_MANUAL.csv"));
